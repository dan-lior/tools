...
The folder nondicom_reader contains c++ code to reads the info written by nondicom_writer and represents it in a C++ "grid" object defined in the core tools directory. 
